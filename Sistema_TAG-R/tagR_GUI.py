...
class FaceOrganizerGUI:
    def __init__(self, root):
        ...
        self.known_faces_dir = tk.StringVar(value=str(self.base_dir / "Faces"))
        self.input_dir = tk.StringVar(value=str(self.base_dir / "Photos"))
        self.output_dir = tk.StringVar(value=str(self.base_dir / "Resultados"))
